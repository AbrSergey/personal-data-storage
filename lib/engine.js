...
module.exports.generateValidationScheme = (initScheme) => {
  const validateScheme = {};
  Object.keys(initScheme).forEach(key => validateScheme[key] = initScheme[key].validation);
  _schema_validate = Joi.object({ ...validateScheme });
}
