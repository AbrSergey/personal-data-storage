...
const { update, insert, getDataByID, find, findOneByKeyInNonSecureData, deleteById, generateModel, setIndexSettings, getModel, validateData } = require("./engine");
...
module.exports = {
  connect: async (url, schema, modelName, key, dbOptions, schemaOptions, algorithm) => {
    ...
    return setIndexSettings(schema, dbOptions, key);
  },
